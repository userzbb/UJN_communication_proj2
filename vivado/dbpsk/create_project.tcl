# create_project.tcl
# Vivado 2025.2 project creation for DBPSK DUT
# Target: AMD Xilinx Zynq-7020 (xc7z020-2clg400)
#
# Usage: vivado -mode batch -source vivado/dbpsk/create_project.tcl
...
# Create project in vivado/dbpsk/
...
puts "========================================"
puts "  Vivado project created: vivado/dbpsk/dbpsk.xpr"
puts "  Target: xc7z020-2clg400"
puts "========================================"
puts ""
puts "Next: open project in Vivado GUI and run simulation,"
puts "  or run: source vivado/dbpsk/sim_dbpsk.tcl"
